            ...
            <div className="grid grid-cols-2 gap-6 relative">
              {PROFILE_DATA.memoryYears.map((memory, index) => {
                ...
                return (
                  <div
                    key={memory.year}
                    className="group relative overflow-hidden rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02] bg-white photo-item cursor-pointer"
